...
app.all(
  ...
  'お電話ありがとうございます。' +
    ...
    '<break time="600ms"/>' +
    'お手数ですが、ラインアプリの公式アカウントからご連絡をお願いいたします。' +
    '<break time="600ms"/>' +
    'ラインアプリで「磯屋　えびせん」と検索していただくか、' +
    'ホームページやチラシのQRコードから友だち追加をお願いします。' +
    '<break time="600ms"/>' +
    'ご不明な点やご注文は、ラインアプリの公式アカウントからトーク画面からメッセージをお送りください。' +
    '<break time="600ms"/>' +
    '順番に確認してご返信いたします。' +
    '<break time="700ms"/>' +
    'それでは、このまま通話を終了させていただきます。' +
    'ありがとうございました。' +
  '</Say>' +
  '</Response>';
